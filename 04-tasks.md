...
1. [구글 폼(link)](https://forms.gle/hoHPVrdvuYTE24ii9)으로 아래의 사항들을 포함한 문제 자료를 전송해 주세요.
   - 출제자 또는 출제진의 실명과 소속
   ...
   - 구글 폼에 입력해야 하는 스팸 방지 암호는 `UCPC2026`입니다.
...
3. 문제가 선정될 경우 운영진의 안내에 협조해 주시기 바랍니다. 대회가 끝나기 전까지는 아래와 같은 사항들이 제한됩니다.
   - **(대회 참가 금지)** UCPC 2026에 참가할 수 없습니다.
...
- UCPC 2026 Call for tasks에 투고되는 문제들은 장근영(azberjibiou, KAIST), 이종서(leejseo, KAIST), 이성현(hibye1217, 한양대학교), 신민철(fefe, KAIST)에 의해 검토됩니다.
- 효율적인 검토를 위해 LLM을 활용할 수 있으나, 투고된 자료가 모델 학습에 사용되지 않도록 설정된 환경에서만 검토를 진행합니다.
